			...
			if($row['numrows'] > 0){
				...
				try{
				    ...
				    try {
				        ...
				        $mail->SMTPAuth = true;                               
				        $mail->Username = 'insert your email@gmail.com'; //insert your email
				        ...
				        $mail->setFrom('insert your email@gmail.com'); //insert your email
				        
				        //Recipients
				        $mail->addAddress($email);              
				        $mail->addReplyTo('insert your email@gmail.com'); //insert your email
